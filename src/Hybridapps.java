...
public class Hybridapps {
	...
	public static void main(String[] args) throws MalformedURLException {
		...
		driver.findElement(By.id("com.example.testappp:id/goButton")).click();
		...
		//To enable WebView debugging, call the static methodsetWebContentsDebuggingEnable on the WebView class.
